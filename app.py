...
with st.sidebar:
    ...
    st.markdown("---")
    st.markdown("👨‍💻 Developed by: **aadhya shrivastava**")
    st.markdown("🔗 GitHub: [aadhya shrivastava](https://github.com/aadhya1328/student_depression_project.git)")
    st.markdown("🔗 LinkedIn: [Profile](https://www.linkedin.com/in/aadhya-shrivastava-93aa77325)")
    st.markdown("---")
